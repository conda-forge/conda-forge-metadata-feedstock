About conda-forge-metadata-feedstock
====================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/conda-forge-metadata-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/conda-forge-metadata-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add conda-forge-metadata
# for installing globally
pixi global install conda-forge-metadata
```
...
It is possible to list all of the versions of `conda-forge-metadata` available on your platform:
...
```
pixi search conda-forge-metadata --channel conda-forge
```
